...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-survey_certification_py3o>=15.0dev,<15.1dev',
        ...
        'odoo-addon-survey_next_survey_update_partner>=15.0dev,<15.1dev',
        ...
        'odoo-addon-survey_xlsx>=15.0dev,<15.1dev',
    ],
    classifiers=[
