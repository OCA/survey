...
class TestSurveyConditionalQuestions(common.SurveyCase, HttpCase):
    def test_survey_conditional_questions(self):
        ...
        conditional_values = {
            ...
            "triggering_answer_id": question.labels_ids[0]["value"],
        }
        ...
        self.env["survey.user_input_line"].save_lines(
            user_input.id, question, {tag: question.labels_ids[0]["value"]}, tag
        )
        ...
        self.env["survey.user_input_line"].save_lines(
            user_input.id, question, {tag: question.labels_ids[1]["value"]}, tag
        )
        user_input.refresh()
        self.assertIn(conditional_question, user_input.get_hidden_questions())
        ...
        self.env["survey.user_input_line"].save_lines(
            ...
            conditional_question,
            {
                ...
                tag: question.labels_ids[1]["value"],
            },
            conditional_tag,
        )
        user_input.refresh()
        ...
        self.assertTrue(not line or line.skipped)
