...
class TestSurveyCertificationProgram(common.TestSurveyCommon):
    ...
    def setUpClass(cls):
        super().setUpClass()
        surveyCertificateProgramLine = cls.env["survey.certificate.program.line"]
        cls.program_line1 = surveyCertificateProgramLine.create(
            {
                "sequence": 1,
                "name": "Program Line 1",
        ...
        cls.program_line2 = surveyCertificateProgramLine.create(
            {
                "sequence": 2,
                "name": "Program Line 2",
            ...
            certification = self.env["survey.survey"].create(
                {
                    ...
                    "certificate_program_line_ids": [
                        (6, 0, [self.program_line1.id, self.program_line2.id])
                    ],
                    "certificate_program_layout": "simple",
                    "access_mode": "public",
